...
$anahakkimizdasor=$db->prepare("SELECT * FROM anahakkimizda WHERE anahakkimizda_id=:id");
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" action="../netting/islem.php" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" name="anahakkimizda_header" value="<?php echo $anahakkimizdacek['anahakkimizda_header']; ?>" placeholder="Lütfen ana sayfa hakkımızda kısmı için header giriniz. " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" name="anahakkimizda_color" value="<?php echo $anahakkimizdacek['anahakkimizda_color']; ?>" placeholder="Lütfen ana sayfa hakkımızda kısmı renk için bilgi giriniz. " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                    ...
                    <script type="text/javascript">
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success" name="anahakkimizdakaydet">Kaydet</button>
                        </div>
                      </div>
                    </form>
