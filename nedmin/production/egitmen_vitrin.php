      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="clearfix"></div>
              <div align="right">
            <a href="egitmen-ekle.php"><button class="btn btn-success btn-xs">Yeni Ekle</button></a>
              </div>
          </div>
          <div class="x_content">
...
?>
    <tr>
        ...
        <td><img width="100px" src="../../<?php echo $egitmencek['egitmen_resimyol']?>"></td>
        <td>
            <form method="POST" style="display:inline;" action="../netting/islem.php">
                <input type="hidden" name="egitmen_id" value="<?php echo $egitmencek['egitmen_id']; ?>">
                <button 
                    type="submit" 
                    name="egitmen_vitrin_durum_degistir"
                    class="btn btn-sm <?php echo $egitmencek['egitmen_vitrin'] == 1 ? 'btn-success' : 'btn-danger'; ?>">
                    <?php echo $egitmencek['egitmen_vitrin'] == 1 ? 'Evet' : 'Hayır'; ?>
                </button>
            </form>
        </td>
