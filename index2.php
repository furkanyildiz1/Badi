            ...
            <div class="col-xl-8 col-lg-7 col-md-12">
                <div class="banner-content d-flex align-items-center">
                    <div class="banner-content-inner">
                        ...
                        <div class="bbtns">
                            <a href="#" class="bg_btn bt">Tüm Kurslar</a>
                            <a href="#" class="wborder_btn bt">İletişim</a>
                        </div>

                        <div class="sinfo">
                            <img src="assets/img/rev-img.png" alt="image" />
                            <span>24k + Mutlu Öğrenci</span>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Start Topics Area -->
<section class="tp-feature-area" style="background-image:url(assets/img/bg/shape-bg-1.png)">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-12">
                <div class="edu-about-image">
                    <img src="assets/img/gecici-resim.png" alt="image">
                </div>
            </div>
                ...
                <div class="edu-about-content">
                    ...
                    <div class="progress-content">
                        <div class="progress-section">
                            ...
                            <div class="progress">
                                <div class="progress-bar psc01" role="progressbar" aria-valuenow="86" aria-valuemin="0"
                        ...
                        <div class="progress-section">
                            <div class="progress-title">
                                <h4>Yazılım Eğitimleri</h4>
                                <span class="title">67%</span>
                            </div>
                            <div class="progress">
                                <div class="progress-bar psc02" role="progressbar" aria-valuenow="67" aria-valuemin="0"
                                    aria-valuemax="100" style="max-width: 67%">
                                </div>
                            </div>
                        </div>
                        <div class="progress-section">
                            ...
                            <div class="progress">
                                <div class="progress-bar psc03" role="progressbar" aria-valuenow="95" aria-valuemin="0"
                                    aria-valuemax="100" style="max-width: 95%">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- start top category section -->
<section class="tp-category-area wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".4s"
    style="background-image: url(&quot;assets/img/bg/shape-bg-1.png&quot;); visibility: visible; animation-duration: 1.5s; animation-delay: 0.4s;">
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2 class="tp-section-title">Popüler Kategoriler</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <?php while ($altkategoricek = $altkategorisor->fetch(PDO::FETCH_ASSOC)) { ?>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-cat-item d-flex align-items-center">
                        <div class="tp-category-icon"><img src="<?php echo $altkategoricek['fav_icon_resimyol'] ?>"
                                alt="category-img">
                        </div>
                        <h4 class="tp-category-title"><a href="/course-grid"><?php echo $altkategoricek['ad']; ?></a></h4>
                    </div>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="row justify-content-center">
            <?php while ($kurscek = $kurssor->fetch(PDO::FETCH_ASSOC)) {
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="tpcourse">
                        <div class="tpcourse__thumb"><a
                                href="kurs-detay.php?kurs_id=<?php echo $kurscek['kurs_id']; ?>"><img
                                    src="<?php echo $kurscek['resim_yol']; ?>" alt="course-thumb" /></a>
                            <div class="tpcourse__tag"><a
                                    href="kurs-detay.php?kurs_id=<?php echo $kurscek['kurs_id']; ?>"><i
                        ...
                        <div class="tpcourse__content">
                            ...
                            <div class="tpcourse__meta">
                                <ul class="align-items-center">
                                    ...
                                    <li><i class="fa-solid fa-user"></i>
                                        <span>
                                            <?php echo isset($ogrsayicek['ogr_sayisi']) && $ogrsayicek['ogr_sayisi'] ? $ogrsayicek['ogr_sayisi'] : 0; ?>
                                            Öğrenci
                                        </span>
                                    </li>
                            ...
                            <div class="tpcourse__category align-items-center">
                                ...
                                <h5 class="tpcourse__course-price">
                                    <!-- --><?php echo number_format($kurscek['fiyat'], 0, '.', ''); ?> TL</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                ...
                <div class="counter-box02">
                    <h3><span class="odometer" data-count="13000">00</span></h3>
                    <p>Toplam Öğrenci</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                ...
                <div class="swiper-wrapper">
                    <?php while ($markacek = $markasor->fetch(PDO::FETCH_ASSOC)) { ?>
                        <div class="swiper-slide swiper-marka">
                            <a href="#"><img src="<?php echo $markacek['marka_resimyol']; ?>" alt="brands"></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
                    ...
                    <div class="whyChoose-list">
                        <div class="items">
                            <div class="edu-whyChoose-img">
                                <img src="assets/img/svg/book-open-svgrepo-com.svg" alt="icon">
                            </div>
                        ...
                        <div class="items">
                            <div class="edu-whyChoose-img">
                                <img src="assets/img/svg/sail-boat-svgrepo-com.svg" alt="icon">
                            </div>
                            <div class="whyChoose-single-content">
...
<!-- eğitmenler section         BURANIN ÇALIŞMAMASINA TAKILMA YARIN SLİDER GÜNCELLEMESİ YAPACAĞIM -->
<section class="instructor-area pt-110 pb-110 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-8 col-md-7 col-12">
                <div class="section-title mb-65">
                    <h2 class="tp-section-title mb-20">Bünyemizdeki Eğitmenlerimiz</h2>
                </div>
            </div>
            <div class="col-xl-6 col-lg-4 col-md-5 col-6">
                <div class="tp-instruc-arrow d-flex justify-content-md-end">
                    <div class="swiper-button-prev-instructor"><i class="fa-solid fa-chevron-left"></i></div>
                    <div class="swiper-button-next-instructor"><i class="fa-solid fa-chevron-right"></i></div>
                </div>
            </div>
        </div>
        <div class="intruc-active mb-15 tp-slide-space">
            <div class="swiper-instructor">
                <div class="swiper-wrapper">
                    <?php
                    while ($egitmencekk = $egitmensorr->fetch(PDO::FETCH_ASSOC)) { ?>
                        <div class="swiper-slide">
                            <div class="tp-instruc-item" style="width:100%; display:inline-block">
                                <div class="tp-instructor text-center p-relative mb-30">
                                    <div class="tp-instructor__thumb mb-25">
                                        <img src="<?php echo $egitmencekk['egitmen_resimyol']; ?>" alt="instructor-profile">
                                    </div>
                                    <div class="tp-instructor__content">
                                        <h4 class="tp-instructor__title mb-20">
                                            <a
                                                href="egitmen_detay.php?egitmen_id=<?php echo $egitmencekk['egitmen_id']; ?>">
                                                <?php echo $egitmencekk['egitmen_adsoyad']; ?>
                                            </a>
                                        </h4>
                                        <span><?php echo $egitmencekk['egitmen_rol']; ?></span>
                                        <div class="tp-instructor__social">
                                            <ul>
                                                <li><a target="_blank"
                                                        href="https://<?php echo $egitmencekk['egitmen_medyabir']; ?>">
                                                        <i class="fab fa-facebook-f"></i></a></li>
                                                <li><a target="_blank"
                                                        href="https://<?php echo $egitmencekk['egitmen_medyaiki']; ?>">
                                                        <i class="fab fa-twitter"></i></a></li>
                                                <li><a target="_blank"
                                                        href="https://<?php echo $egitmencekk['egitmen_medyauc']; ?>">
                                                        <i class="fab fa-instagram"></i></a></li>
                                                <li><a target="_blank"
                                                        href="https://<?php echo $egitmencekk['egitmen_medyadort']; ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="instructor-btn text-center">
                    <a class="tp-btn" href="instructor">Tüm Eğitmenler</a>
                </div>
            </div>
        </div>
    </div>
</section>
<!-- eğitmenler section bitiş -->
...
<div class="edu-blog-area sectionBg05 ptb-100">
    <div class="container">
        <div class="edu-section-title text-start">
            ...
            <a href="#" class="default-btn">Hepsini Gör</a>
        </div>
        <div class="row justify-content-center">
                    ...
                    <div class="single-blog-box">
                        <div class="image">
                            ...
                            <a href="blog-details.php?blog_id=<?php echo $blogcek['blog_id']; ?>" class="d-block">
                                <img src="<?php echo $blogcek['blog_resimyol']; ?>" alt="image">
                            </a>
                            <div class="cr-tag">
                        ...
                        <div class="content">
                            <ul class="cr-items">
                                <li><a href="#"><i
                                            class='bx bx-user'></i><span><?php echo $blogcek['yazar_ad']; ?></span></a></li>
                                <li>
                                    ...
                                    <span>
                                        ...
                                        echo strftime('%d %B %Y', strtotime($blogcek['blog_tarih'])); 
                                        ?>
                                    </span>
                                </li>
                            </ul>
                            ...
                            <a class="blog-btn" href="blog-details.php?blog_id=<?php echo $blogcek['blog_id']; ?>">Devamını
                                oku...</a>
                        </div>
                    </div>
                </div>
