...
class __TwigTemplate_bf6d2aace79f2254587c7c16b3e1d5e3 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\blog_project\\phpmyadmin\\templates\\database\\export\\index.twig");
    }
}
